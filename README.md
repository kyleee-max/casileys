...
# GitHub
"dependencies": {
   "@kaels/casileys": "github:kaels/casileys"
}
```
...
- 📢 Auto-follow 1 update channel for bot info (transparent, can be unfollowed anytime).
...
const groupName = '@kaels/casileys'
...
sock.sendMessage(jid, {
   ...
   product: {
      ...
      signedUrl: 'https://www.npmjs.com/package/@kaels/casileys',
...
sock.sendMessage(jid, {
   ...
   offerCode: '@kaels/casileys', // --- Optional
   offerUrl: 'https://www.npmjs.com/package/@kaels/casileys', // --- Optional
...
sock.sendMessage(jid, {
   ...
   cards: [{
      ...
      offerCode: '@kaels/casileys',
      offerUrl: 'https://www.npmjs.com/package/@kaels/casileys',
...
sock.sendMessage(jid, {
   ...
   externalAdReply: {
      ...
      url: 'https://www.npmjs.com/package/@kaels/casileys' // --- Optional, used for WhatsApp internal thumbnail caching and direct URL
   }
}, {
   quoted: message
})
...
```javascript
// --- Create a new one
sock.newsletterCreate('@kaels/casileys', '📣 Fresh updates weekly')
...
// --- Update newsletter
sock.newsletterUpdate('1231111111111@newsletter', { name: '@kaels/casileys' })

// --- Change name
sock.newsletterUpdateName('1231111111111@newsletter', '📦 @kaels/casileys')
...
const group = sock.groupCreate('@kaels/casileys', ['628123456789@s.whatsapp.net'])
...
// --- Change name
sock.groupUpdateSubject(jid, '📦 @kaels/casileys')
...
sock.updateMemberLabel(jid, '@kaels/casileys')
```
...
const community = await sock.communityCreate('@kaels/casileys', '📣 Fresh updates weekly')
...
// --- Change name
sock.communityUpdateSubject(jid, '📦 @kaels/casileys')
...
await sock.updateBusinessProfile({
   ...
   websites: ['https://www.npmjs.com/package/@kaels/casileys'],
